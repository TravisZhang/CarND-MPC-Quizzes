...
// NOTE: There are 6 states (x y psi v cte epsi) & 2 actuations (delta a), the states exist for each timestep,
// but the actuations exist only from the 2nd timestep. So there are totally 6*N states & 2*(N-1) actuations
